  ...
  return (
    <section className="content-card">
      ...
      <div className="about-text">
        <p>
          I am a passionate and recently graduated MERN Stack Developer based in
          Lahore, Pakistan. With hands-on experience from my internship at MJ
          Programmers, I specialize in building robust, scalable, and dynamic
          web applications using MongoDB, Express.js, React.js, and Node.js. I
          thrive on turning complex problems into efficient code, whether it's
          building responsive frontend interfaces, architecting secure backend
          APIs, or integrating modern technologies like AI. I am eager to bring
          my technical skills and enthusiasm to a dynamic development team.
        </p>
